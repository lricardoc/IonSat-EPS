...
O = 180; %Right ascension of the right ascending node (degrees) %max 197, min 300.5 %181  300
o = 150; %Argument of the perigee (degrees)                      %max 90, min 0      %90  90
