...
O = 243; %Right ascension of the right ascending node (degrees) %max 197, min 300.5 %181
...
EPS_orbit_v2_R2019a
Power=sim('EPS_orbit_v2_R2019a');

EPS_sim_test_v2_R2019a
E=sim('EPS_sim_test_v2_R2019a');
