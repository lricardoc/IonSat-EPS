...
void untitled2_initialize(void)
{
  ...
  /* External mode info */
  untitled2_M->Sizes.checksums[0] = (297413546U);
  untitled2_M->Sizes.checksums[1] = (364382941U);
  untitled2_M->Sizes.checksums[2] = (3471709845U);
  untitled2_M->Sizes.checksums[3] = (3625640203U);
