...
#ifndef RTW_HEADER_closedloop_types_h_
#define RTW_HEADER_closedloop_types_h_
#include "rtwtypes.h"
...
typedef struct tag_lMInmD9zWRzKpUCrv0OfsC codertarget_arduinobase_int_b_T;

#endif                               /*typedef_codertarget_arduinobase_int_b_T*/

/* Parameters (default storage) */
typedef struct P_closedloop_T_ P_closedloop_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_closedloop_T RT_MODEL_closedloop_T;

#endif                                 /* RTW_HEADER_closedloop_types_h_ */
