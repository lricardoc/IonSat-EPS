...
void openloop_initialize(void)
{
  ...
  /* External mode info */
  openloop_M->Sizes.checksums[0] = (511734241U);
  openloop_M->Sizes.checksums[1] = (3088783175U);
  openloop_M->Sizes.checksums[2] = (952606476U);
  openloop_M->Sizes.checksums[3] = (2832566133U);
